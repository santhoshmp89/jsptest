...
var MainConfig = /** @class */ (function () {
    ...
    MainConfig.config = {
        ...
        ajaxDomains: '',
        useBenchmark: false,
        lastMileUrl: _g.protocol + 'portalstage.catchpoint.com/jp/91733/v4.0.11/LastMileScript.js',
        benchMarkPageGroups: '',
        sessionReplayEnabled: false,
        sessionReplayScriptUrl: _g.protocol + 'portalstage.catchpoint.com/jp/91733/v4.0.11/SessionReplayScript.js',
        ...
        switch (_a.label) {
            case 0:
                ...
                getAppDetails = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fetch('https://portalstage.catchpoint.com/jp/91733/v4.0.11/AC')];
                            case 1:
                                response = _a.sent();
...
var RProfiler = /** @class */ (function () {
    function RProfiler() {
        ...
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        this.restUrl = 'portalstage.catchpoint.com/jp/91733/v4.0.11/M';
        this.startTime = new Date().getTime();
